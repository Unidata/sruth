...
public final class PublisherApp {
    ...
    PublisherApp(final Container container, final ActionListener doneListener) {
        ...
        botPanel
                .add(getCancelButton(), new CC().alignX("right").sizeGroup("1"));
    ...
    private Component getPortSelectionPanel() {
        ...
        minPortField.setToolTipText("Minimum potential port number (1 - "
                + (PortNumberSet.MAX_PORT_NUMBER - Connection.SOCKET_COUNT)
                + ")");
        ...
        maxPortField.setToolTipText("Maximum potential port number (1 - "
    ...
    private void execute() {
        ...
        botPanel.removeAll();
        try {
            publisher = new Publisher(rootDir.toPath(), portSet);
