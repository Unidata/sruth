 ...
 */
@NotThreadSafe
final class MinHeapFile<T extends MinHeapFile.Element> {
    /**
    ...
    abstract static class Element implements Comparable<Element> {
         ...
         * @return The instance corresponding to the byte-buffer.
         * @throws IOException
         *             if an I/O error occurs.
         */
     ...
     *             if the file exists but was created with a different {@code
     *             eltSize}.
     * @throws IllegalArgumentException
     *             if {@code eltSize <= 0}.
     * @throws IOException
     ...
     *             if an element can't be created.
     */
    synchronized Element remove() throws IOException, InstantiationException,
