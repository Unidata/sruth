...
/**
 * The server for source-nodes.
 * 
 * Instances are thread-safe.
 * 
 * @author Steven R. Emmerson
 */
final class SourceServer extends Server {
    /**
     ...
     * @see #SourceServer(Predicate, ClearingHouse, PortNumberSet)
     */
    SourceServer(final ClearingHouse clearingHouse) throws IOException {
        super(clearingHouse);
    }
     ...
     * @param inetSockeAddrSet
     *            The set of candidate socket addresses for the server.
     * @throws IOException
     ...
     */
    SourceServer(final ClearingHouse clearingHouse,
     ...
     */
    @Override
    void adjustSocket(final ServerSocket socket) throws IOException {
        // socket.setReuseAddress(true); // the reason for this subclass
    }
}
