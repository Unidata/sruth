...
class SimpleIterator<T> implements Iterator<T> {
     ...
     * Called by {@link #SimpleIterator()} and {@link #next()}. Returns
     * {@code null} when the iteration has no more elements.
     * <p>
     * Override this method judiciously because it will be called by the
     * constructor {@link #SimpleIterator()} before the subclass is constructed
     * -- in particular, it will be called before any instance fields of the
