...
public class MultiClientTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        system(new String[] { "rm", "-rf", "/tmp/server",
                "/tmp/client-series-1", "/tmp/client-series-2",
                "/tmp/client-parallel-1", "/tmp/client-parallel-2",
                "/tmp/client-series-1", "/tmp/client-series-2" });
        system(new String[] { "mkdir", "-p", "/tmp/client-series-1",
                "/tmp/client-series-2", "/tmp/client-parallel-1",
                "/tmp/client-peer-2", "/tmp/client-peer-1",
                "/tmp/client-parallel-2" });
    ...
    public static void tearDownAfterClass() throws Exception {
        system(new String[] { "rm", "-rf", "/tmp/server",
                "/tmp/client-series-1", "/tmp/client-parallel-1",
                "/tmp/client-series-2", "/tmp/client-parallel-2",
                "/tmp/client-peer-1", "/tmp/client-peer-2" });
    }
